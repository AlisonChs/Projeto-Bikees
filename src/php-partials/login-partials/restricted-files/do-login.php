<?php 
    ...
    $strSQL = "SELECT id_user, user_name, user_full_name, user_cpf, user_email, user_password, user_cash FROM tb_user WHERE user_email = '$email'";
    ...
    if ($consult) {
        ...
        while($row = mysqli_fetch_array($address_consult)) {
            ...
            $_SESSION['cep_address'] = $row['cep_address'];
